      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">Owned</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">Auto SEO</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="font-medium text-green-900">Preview Next SEO Post</span>
                </Link>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="text-center py-4">
                ...
                <p className="text-gray-600 mb-4">
                  Blog posts are managed by the owned autonomous SEO writer.
                </p>
                <Link
                  href="/admin/blog"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 border border-gray-200 rounded-lg">
                ...
                <p className="text-sm text-gray-600 mb-3">
                  View owned blog posts generated for Jacksonville junk removal SEO.
                </p>
                <Link href="/admin/blog" className="text-secondary hover:text-primary text-sm font-medium">
                  Manage Blog -&gt;
                </Link>
              </div>
              ...
              <div className="p-4 border border-gray-200 rounded-lg">
                ...
                <p className="text-sm text-gray-600 mb-3">Configure website settings and preferences.</p>
          ...
          <div className="mt-8 bg-gray-50 rounded-lg p-6">
            ...
            <p className="text-primary text-sm mb-3">Tips for managing owned SEO content:</p>
            <ul className="text-primary text-sm space-y-1">
              <li>Use markdown for rich owned blog content.</li>
              <li>Keep meta titles and descriptions focused on Jacksonville search intent.</li>
              <li>Review generated posts before promoting them as featured.</li>
              <li>Keep content fresh and relevant to Jacksonville junk removal.</li>
              <li>Let the weekly autonomous writer grow the blog on schedule.</li>
            </ul>
          </div>
        </div>
      </div>
