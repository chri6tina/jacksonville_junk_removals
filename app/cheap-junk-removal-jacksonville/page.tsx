...
export const metadata: Metadata = {
  title: 'Cheap Junk Removal Jacksonville FL | Best Prices Guaranteed',
  description: 'Looking for cheap junk removal in Jacksonville? We offer the best prices in town with same-day service. Starting at just $99 for quarter-truck loads. Licensed, insured, and eco-friendly.',
  keywords: 'cheap junk removal Jacksonville, affordable junk removal, budget junk removal, Jacksonville junk removal prices, cheap hauling Jacksonville, low cost junk removal',
  alternates: {
    canonical: '/cheap-junk-removal-jacksonville',
  },
}
...
const pricingTiers = [
  {
    ...
    originalPrice: '$150',
    savings: '$51',
    description: 'Perfect for small cleanouts, garage organization, or moving prep',
  ...
  },
  {
    ...
    originalPrice: '$299',
    savings: '$100',
    description: 'Great for medium cleanouts, room clearouts, or small moves',
  ...
  },
  {
    ...
    originalPrice: '$399',
    savings: '$100',
    description: 'Best for large cleanouts, estate sales, or major renovations',
...
const whyChooseUs = [
  ...
  },
  {
    ...
    description: 'Need junk removed today? We offer same-day service for most requests in Jacksonville.'
  },
  {
    icon: Shield,
  ...
  },
  {
    icon: Leaf,
    title: 'Eco-Friendly',
    description: 'We recycle and donate whenever possible, keeping Jacksonville green and clean.'
  }
]

const serviceAreas = [
  'Downtown Jacksonville', 'Riverside', 'San Marco', 'Mandarin', 
  'Arlington', 'Orange Park', 'Southside', 'Jacksonville Beach'
]

export default function CheapJunkRemovalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold mb-6">
            ...
            <br />
            <span className="text-2xl lg:text-3xl">Jacksonville, FL</span>
          </h1>
          
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            The most affordable junk removal service in Jacksonville. Starting at just <strong className="text-blue-400">$99</strong> for quarter-truck loads. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Jacksonville's Most Affordable Junk Removal Prices
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Transparent pricing with no hidden fees. We guarantee the best prices in Jacksonville or we'll beat any written estimate by 10%.
            </p>
          </div>
      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why We're Jacksonville's #1 Cheap Junk Removal Service
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We don't just offer cheap prices - we provide exceptional value with professional service.
            </p>
          </div>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Providing cheap junk removal services throughout Jacksonville and surrounding areas.
            </p>
          </div>
      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              What We Remove (Cheap!)
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From furniture to appliances, we remove almost anything at unbeatable prices.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Furniture & Appliances</h3>
              <ul className="space-y-2 text-gray-600">
                <li>• Sofas, chairs, tables</li>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Construction Debris</h3>
              <ul className="space-y-2 text-gray-600">
                <li>• Drywall, lumber, flooring</li>
                <li>• Concrete and bricks</li>
                <li>• Roofing materials</li>
                <li>• Insulation and wiring</li>
              </ul>
            </div>
            
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">General Junk</h3>
              <ul className="space-y-2 text-gray-600">
                <li>• Electronics and computers</li>
                <li>• Yard waste and debris</li>
                <li>• Moving boxes and packing</li>
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Ready for Cheap Junk Removal in Jacksonville?
          </h2>
          <p className="text-lg text-gray-300 mb-8">
            Get your free quote today. No hidden fees, no surprises - just honest, affordable junk removal service.
          </p>
