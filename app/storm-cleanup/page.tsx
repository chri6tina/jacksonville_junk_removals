...
import { Phone, Clock, MapPin, Shield, Truck, Leaf, AlertTriangle, CheckCircle, Star } from 'lucide-react'
...
export default function StormCleanupPage() {
  ...
  "@type": "Service",
  "serviceType": "Storm Cleanup Jacksonville",
  "provider": {
    "@type": "LocalBusiness",
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-200 leading-relaxed max-w-xl font-medium drop-shadow-md mx-auto lg:mx-0">
                  Emergency storm damage cleanup and hurricane debris removal. Available 24/7 during storms to keep Jacksonville safe and clean.
                </p>
              </div>
