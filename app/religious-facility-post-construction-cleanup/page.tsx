...
export default function ReligiousFacilityPostConstructionCleanupPage() {
  ...
  "@type": "Service",
  "serviceType": "Religious Facility Post-Construction Cleanup Jacksonville",
  "provider": {
    "@type": "LocalBusiness",
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <h1 className="text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight drop-shadow-xl">
                  Religious Facility <br /> <span className="text-purple-300">Post-Construction Cleanup</span>
                </h1>
                
                <p className="text-xl text-gray-200 leading-relaxed max-w-xl font-medium drop-shadow-md mx-auto lg:mx-0">
                  <span className="text-purple-300 font-bold">JACKSONVILLE'S RELIGIOUS FACILITY CLEANUP SPECIALISTS</span><br /> Serving Churches, Temples & Worship Centers Across All Jacksonville Areas<br /> Transform construction sites into pristine, sacred spaces.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg">
                <div className="flex items-center mb-6">
                  <Cross className="w-12 h-12 text-secondary mr-4" />
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg">
                <div className="flex items-center mb-6">
                  <StarIcon className="w-12 h-12 text-secondary mr-4" />
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg">
                <div className="flex items-center mb-6">
                  <Heart className="w-12 h-12 text-secondary mr-4" />
