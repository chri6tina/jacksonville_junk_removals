...
import { Building2, Truck, Shield, Clock, DollarSign, CheckCircle, Star, Phone, Users, Briefcase, MapPin, Home, Building, Car, Coffee, TreePine } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Commercial Junk Removal Mandarin Jacksonville - Suburban Business Cleanout (904) 456-3851',
  description: 'Professional commercial junk removal services in Mandarin Jacksonville. Suburban business cleanouts, office cleanup, retail clearouts, and commercial equipment removal. Fast response, licensed crews. Call (904) 456-3851.',
  keywords: 'commercial junk removal Mandarin Jacksonville, Mandarin business cleanout, suburban office cleanup, Mandarin retail cleanout, Jacksonville commercial junk removal',
  alternates: {
    canonical: '/commercial-junk-removal-mandarin',
  },
}
...
const commercialBenefits = [
  {
    ...
    description: 'We work efficiently to get your Mandarin business back to normal operations quickly',
    icon: '⚡'
  },
  {
  ...
  },
  {
    ...
    description: 'Competitive pricing with volume discounts for large Mandarin projects',
    icon: '💰'
  },
  {
    benefit: 'Professional Service',
    description: 'Experienced crews that understand Mandarin commercial property requirements',
    icon: '👷'
  }
]

export default function CommercialJunkRemovalMandarinPage() {
  return (
      ...
      <div className="bg-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
            Professional commercial junk removal services for Mandarin Jacksonville businesses. 
            Suburban business cleanouts, office cleanup, retail clearouts, and more.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <span>Contact Mandarin Team</span>
            </Link>
          </div>
        </div>
      </div>
  ...
  "@type": "Service",
  "serviceType": "Commercial Junk Removal Mandarin Jacksonville - Suburban Business Cleanout (904) 456-3851",
  "provider": {
    "@type": "LocalBusiness",
...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center space-x-3">
            ...
            <span className="text-lg font-semibold">
              🏢 MANDARIN JACKSONVILLE COMMERCIAL JUNK REMOVAL SPECIALISTS 🏢
            </span>
            <Building2 className="w-6 h-6" />
          </div>
          <p className="mt-2 text-sm">
            Call (904) 456-3851 • Serving Mandarin & Suburban Areas • Same-Day Service Available
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Mandarin Commercial Areas We Serve
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive commercial junk removal across all Mandarin Jacksonville business districts and commercial areas
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Mandarin Boulevard</h3>
              <p className="text-gray-600 mb-4">
                Main commercial corridor with shopping centers, restaurants, and professional services
              </p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Mandarin Retail</h3>
              <p className="text-gray-600 mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Mandarin Commercial Services
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Professional commercial junk removal services tailored for Mandarin Jacksonville businesses
            </p>
          </div>
      ...
      {/* Mandarin Commercial Features */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Mandarin Commercial Projects?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Suburban expertise combined with professional commercial service standards
            </p>
          </div>
      ...
      {/* Mandarin Commercial Features List */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Professional commercial junk removal features designed for Mandarin businesses
            </p>
          </div>
      ...
      {/* Mandarin Commercial Projects */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Recent Mandarin Commercial Projects
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Successfully completed commercial junk removal projects across Mandarin Jacksonville
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12">
            {/* Mandarin Office Complex */}
            <div className="bg-gray-50 rounded-lg p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Mandarin Office Complex Cleanout</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-gray-700">Location:</span>
                  <span className="text-gray-600">Mandarin Business District</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-gray-700">Project Size:</span>
                  <span className="text-gray-600">18,000 sq ft</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            {/* Mandarin Restaurant Renovation */}
            <div className="bg-gray-50 rounded-lg p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Mandarin Restaurant Renovation</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-gray-700">Location:</span>
                  <span className="text-gray-600">Mandarin Boulevard</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-gray-700">Project Size:</span>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-800 to-blue-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Ready for Mandarin Commercial Junk Removal?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            Get instant quotes and professional service for your Mandarin Jacksonville commercial project
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/estimation"
