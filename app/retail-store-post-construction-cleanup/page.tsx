...
export default function RetailStorePostConstructionCleanupPage() {
  ...
  "@type": "Service",
  "serviceType": "Retail Store Post-Construction Cleanup Jacksonville",
  "provider": {
    "@type": "LocalBusiness",
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-200 leading-relaxed max-w-xl font-medium drop-shadow-md mx-auto lg:mx-0">
                  <span className="text-emerald-300 font-bold">JACKSONVILLE'S #1 RETAIL CONSTRUCTION CLEANUP SERVICE</span><br /> Specialized cleaning for retail stores, shopping centers, and commercial retail facilities.<br /> Customer-ready results, visual merchandising preparation, and retail environment standards.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-lg p-8 border-2 border-secondary/30 relative">
                ...
                <div className="text-center mb-6">
                  <span className="text-4xl font-bold text-secondary">$4.00</span>
                  <span className="text-gray-600">/sq ft</span>
                </div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
              ...
              <div className="bg-gray-50 rounded-lg p-8 border-2 border-gray-200">
                ...
                <div className="text-center mb-6">
                  <span className="text-4xl font-bold text-secondary">$5.75</span>
                  <span className="text-gray-600">/sq ft</span>
                </div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <Shirt className="w-16 h-16 text-secondary mx-auto mb-4" />
