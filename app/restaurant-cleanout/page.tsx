          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-lg font-semibold">
                🍽️ PROFESSIONAL RESTAURANT CLEANOUT SERVICES 🍽️
              </span>
              <Utensils className="w-6 h-6" />
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  <li>• Stove and oven removal</li>
                  <li>• Refrigerator disposal</li>
                  <li>• Food prep equipment</li>
                  <li>• Kitchen appliance removal</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  <li>• Table and chair removal</li>
                  <li>• Booth disposal</li>
                  <li>• Food service items</li>
                  <li>• Dining room cleanup</li>
                </ul>
              </div>
