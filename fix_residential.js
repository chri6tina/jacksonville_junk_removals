const fs = require('fs');
let content = fs.readFileSync('app/residential-junk-removal/page.tsx', 'utf8');

content = content.replace(/bg-yellow-400/g, 'bg-secondary');
content = content.replace(/hover:bg-yellow-500/g, 'hover:bg-orange-600');
...
const heroRegex = /\{\/\* Hero Section \*\/\}[\s\S]*?(?=\{\/\* Service Overview \*\/)/;
...
fs.writeFileSync('app/residential-junk-removal/page.tsx', content);
console.log('Fixed');
